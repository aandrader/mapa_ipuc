...
export const Dialog = () => {
  ...
  return isOpen ? (
    <div className="absolute top-0 right-0 w-screen h-screen bg-blur above-map ">
      <div ref={dialogRef} className={`absolute absolute-center z-[9000] card p-4 w-[300px] `}>
        <div className="flex">
          <h1 className="font-medium text-lg leading-5 text-blue-ipuc-800">
            ¡Dios le bendiga soy Samuel Andrade!
          </h1>
          <CloseIcon onClick={() => setIsOpen(false)} />
        </div>

        <p className="mt-2">
          Para actualizar la información del templo (ubicación, horarios de culto, foto o redes sociales) por
          favor hacer la solicitud por correo.
        </p>

        <div className="flex items-center justify-between mt-2">
          <Link target="_blank" rel="external" href={"mailto:samuelandraderive@gmail.com"}>
            <button className="rounded-2xl bg-gradient-to-r from-blue-ipuc-700 to-blue-500 text-white gap-2 py-2 px-3 text-sm ">
